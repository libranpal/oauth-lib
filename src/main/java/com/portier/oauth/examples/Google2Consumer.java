...
/**
 * This class provides an example on how to consume the oauth API
 * for Google oauth2 authentication.
 * @deprecated need to use outside this project as properties file have been moved away
 * @author sin
 */
@Deprecated
public final class Google2Consumer
{
  /**
   * Test code for google auth.
   *
   * @throws Exception In case of any errors.
   * @deprecated
   */
  @Deprecated
  public static void testGoogleAuth() throws Exception
  {
    ...
    final AuthenticationContext ctx =
        new AuthContextImpl(
            ...
            {
              @Override
              public Response handleCompletion(
                  AuthenticationContext ctx1)
              {
                final TokenResult result = ctx1.getTokenResult();
                final String accessToken = result.getAccessToken();
                final String userId = ctx1.getUserId();
    ...
    oauthsvc.startAuthentication(ctx);
  }
}
