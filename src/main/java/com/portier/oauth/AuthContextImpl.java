...
/**
 * This class provides an implementation of the AuthenticationContext. An instance
 * of this class should be used to maintain the entire oauth context during
 * the authorization process.
 * @author sin 
 */
public final class AuthContextImpl implements AuthenticationContext
{
  // The user id who is being authenticated over social network.
  private String userId;

  // The oauth code grant flow.
  private OAuth2CodeGrantFlow codeGrantFlow;

  // The oauth callback handler.
  private final AuthenticationCompletionHandler handler;
   ...
   *
   * @param handler The oauth2 callback handler.
   * @throws NullPointerException In case the supplied handler is null.
   */
  public AuthContextImpl(
      final AuthenticationCompletionHandler handler)
      throws NullPointerException
  {
    if (handler == null)
    {
      throw new NullPointerException("Invalid value for handler");
    }
   ...
   */
  @Override
  public OAuth2CodeGrantFlow getOAuthFlow()
  {
   ...
   */
  @Override
  public void setOAuthFlow(final OAuth2CodeGrantFlow codeGrantFlow)
  {
   ...
   */
  @Override
  public AuthenticationCompletionHandler getCallbackHandler()
  {
    return handler;
  }
   ...
   */
  @Override
  public void setTokenResult(final TokenResult tokenResult)
  {
   ...
   */
  @Override
  public void setCustomData(final JsonObject customData)
  {
