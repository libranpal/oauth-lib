...
/**
 * This class defines the context used in the oauth2 authentication process.
 * @author sin
 */
public interface AuthenticationContext
{
  /**
   * Returns a non-null user id.
   *
   * @return The user id.
   */
  String getUserId();
  ...
  /**
   *  Returns the OAuth2 grant flow.
   *
   * @return OAuth2 grant flow.
   */
  OAuth2CodeGrantFlow getOAuthFlow();



  /**
   * Sets the OAuth2 code grant flow.
   *
   * @param grantFlow  The code grant flow.
   */
  void setOAuthFlow(OAuth2CodeGrantFlow grantFlow);



  /**
   * Returns the token result after oauth flow complete.
   *
  ...
  /**
   * Returns custom data from the UI.
   *
  ...
  /**
   * Returns the OAuth2 callback handler.
   *
   * @return The Oauth2 callback handler.
   */
  AuthenticationCompletionHandler getCallbackHandler();
}
