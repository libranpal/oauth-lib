...
/**
 * This class defines a handler that must be invoked when the oauth
 * flow completes, either successfully, or unsuccessfully.
 * @author sin
 */
public interface AuthenticationCompletionHandler
{
  /**
   *  Handles the completion of the oauth flow.
   *
   * @param ctx The oauth context.
   * @return The response.
   */
  Response handleCompletion(AuthenticationContext ctx);



  /**
   * Handles the error condition of the oauth flow.
   * 
