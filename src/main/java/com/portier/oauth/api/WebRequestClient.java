...
/**
 * This class describes a client that services an HTTP Authentication
 * request.
 *
 * @param <T> The type of result after execution.
 * @author sin
 */
public interface WebRequestClient<T>
{
  /**
   * Executes the authentication request sent by the client.
   *
   * @param context The oauth context.
   * @return The type of result.
   */
  T startAuthGrantFlow(AuthenticationContext context);
}