...
package com.portier.oauth.utils;
...
{
  /**
   * Defines the redirect URI to handle the response.
   */
  public static final String REDIRECT_URI = "REDIRECT_URI";

  /**
   * The credential store.
   * //FIXME: This should be store in the JCKES.
   */
  private static final ResourceBundle cfgResourceBundle =
      ResourceBundle.getBundle("oauth-config");



  /**
   * Returns a configuration property as defined in the resource bundle.
   *
  ...
  {
    final String url = cfgResourceBundle.getString(key);
    return url;
  }
  ...
  /**
   * Generates a random state to be used in the oauth communication.
   *
