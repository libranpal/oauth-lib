...
/**
 * This class defines an interface for OAuth Service. The Library
 * should provide a default implementation for this class.
 * @author sin
 */
public interface OAuthService
{
  /**
   * Starts the phase one of the oauth flow. This flow will return
   * the authorization code returned by the service provider.
   *
   * @param context A non-null reference to a AuthenticationContext object.
   * @return The oauth2 redirection response.
   * @throws Exception  In case of any errors.
   */
  Response startAuthentication(AuthenticationContext context)
      throws Exception;
}
