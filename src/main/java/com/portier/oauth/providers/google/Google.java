...
package com.portier.oauth.providers.google;

import static com.portier.oauth.providers.google.GoogleConstants.CLIENT_ID_GOOGLE;
import static com.portier.oauth.providers.google.GoogleConstants.CLIENT_SECRET_GOOGLE;
import static com.portier.oauth.providers.google.GoogleConstants.GOOGLE_SCOPE;
...
/**
 * This class defines a generic Google2 OAuth client.
 * @author sin
 */
public final class Google extends OAuthProvider
{
  /**
  ...
  public Google()
  {
    ...
    this.clientId = getConfigProperty(CLIENT_ID_GOOGLE);
    this.clientSecret = getConfigProperty(CLIENT_SECRET_GOOGLE);
      ...
      final String state)
  {
    ...
    log.debug("Google Client ID ->" + getClientId());
    log.debug("Google Client SECRET ->" + getClientSecret());
    log.debug("Google SCOPE ->" + GOOGLE_SCOPE);
