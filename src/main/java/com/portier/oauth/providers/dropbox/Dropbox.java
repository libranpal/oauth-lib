...
package com.portier.oauth.providers.dropbox;

import static com.portier.oauth.providers.dropbox.DropboxConstants.CLIENT_ID_DROPBOX;
import static com.portier.oauth.providers.dropbox.DropboxConstants.CLIENT_SECRET_DROPBOX;
import static com.portier.oauth.providers.dropbox.DropboxConstants.DROPBOX_AUTHORIZE_URL;
import static com.portier.oauth.providers.dropbox.DropboxConstants.DROPBOX_TOKEN_URL;
...
/**
 * This class implements Dropbox oauth provider.
 * @author sin
 */
public final class Dropbox extends OAuthProvider
{
  /**
  ...
  public Dropbox()
  {
    ...
    this.clientId = getConfigProperty(CLIENT_ID_DROPBOX);
    this.clientSecret = getConfigProperty(CLIENT_SECRET_DROPBOX);
      ...
      final String state)
  {
    ...
    log.debug("Dropbox Client ID ->" + getClientId());
    log.debug("Dropbox Client SECRET ->" + getClientSecret());
    log.debug("Dropbox authorization URL ->" + DROPBOX_AUTHORIZE_URL);
    log.debug("Dropbox token URL ->" + DROPBOX_TOKEN_URL);
