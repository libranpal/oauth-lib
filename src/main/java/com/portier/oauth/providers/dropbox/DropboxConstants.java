...
/**
 * This class defines constants for Dropbox services.
 * @author sin
 */
public final class DropboxConstants
{
   ...
   * The upload uri.
   */
  public static final String DROPBOX_UPLOAD_URI =
      "https://content.dropboxapi.com/1/files_put/auto";

  /**
   * The root list.
   */
  public static final String DROPBOX_ROOT_LIST =
      "https://api.dropbox.com/1/metadata/auto";

  /**
   * The authorize url.
   */
  public static final String DROPBOX_AUTHORIZE_URL =
      "https://www.dropbox.com/1/oauth2/authorize";

  /**
   * The token url.
   */
  public static final String DROPBOX_TOKEN_URL =
      "https://www.dropbox.com/1/oauth2/token";

  /**
   * The client id.
   */
  public static final String CLIENT_ID_DROPBOX = "CLIENT_ID_DROPBOX";

  /**
   * The client secret.
   */
  public static final String CLIENT_SECRET_DROPBOX =
      "CLIENT_SECRET_DROPBOX";
}
