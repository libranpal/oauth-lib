...
/**
 * This class defines constants for Box services.
 * @author sin
 */
public final class BoxConstants
{
   ...
   * The upload URI.
   */
  public static final String BOX_UPLOAD_URI =
      "https://upload.box.com/api/2.0/files/content";

  /**
   * The root folder.
   */
  public static final String BOX_ROOT =
      "https://api.box.com/2.0/folders";

  /**
   * The get url.
   */
  public static final String BOX_GET_FILE =
      "https://api.box.com/2.0/files";

  /**
   * The authorize url.
   */
  public static final String BOX_AUTHORIZE_URL =
      "https://app.box.com/api/oauth2/authorize";

  /**
   * The token url.
   */
  public static final String BOX_TOKEN_URL =
      "https://api.box.com/oauth2/token";

  /**
   * The client id.
   */
  public static final String CLIENT_ID_BOX = "CLIENT_ID_BOX";

  /**
   * The secret.
   */
  public static final String CLIENT_SECRET_BOX = "CLIENT_SECRET_BOX";
}
