...
package com.portier.oauth.providers.box;

import static com.portier.oauth.providers.box.BoxConstants.BOX_AUTHORIZE_URL;
import static com.portier.oauth.providers.box.BoxConstants.BOX_TOKEN_URL;
import static com.portier.oauth.providers.box.BoxConstants.CLIENT_ID_BOX;
import static com.portier.oauth.providers.box.BoxConstants.CLIENT_SECRET_BOX;
...
/**
 * This class defines a generic Box OAuth client.
 * @author sin
 */
public final class Box extends OAuthProvider
{
  /**
  ...
  public Box()
  {
    ...
    this.clientId = getConfigProperty(CLIENT_ID_BOX);
    this.clientSecret = getConfigProperty(CLIENT_SECRET_BOX);
      ...
      final String state)
  {
    ...
    log.debug("BOX Client ID ->" + getClientId());
    log.debug("BOX Client SECRET ->" + getClientSecret());
    log.debug("Box authorization URL ->" + BOX_AUTHORIZE_URL);
    log.debug("Box token URL ->" + BOX_TOKEN_URL);
    log.debug("Redirect URI ->" + getRedirectURI());
    return OAuth2ClientSupport.authorizationCodeGrantFlowBuilder(
        new ClientIdentifier(getClientId(),
            getClientSecret()),
        BOX_AUTHORIZE_URL,
        BOX_TOKEN_URL)
