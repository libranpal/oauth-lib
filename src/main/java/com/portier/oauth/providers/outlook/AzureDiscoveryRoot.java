...
/**
 * Azure directory root into.
 * @author DJ
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class AzureDiscoveryRoot
{
  /**
   * List of entities.
   */
  public AzureDiscoveryEntity[] value;



  /**
   * get the v2 version.
   * @return AzureDiscoveryEntity
   */
  public AzureDiscoveryEntity getAzureEntityV2()
  {
    for (AzureDiscoveryEntity rec : value)
    {
      if (rec.serviceApiVersion.equals("v2.0"))
      {
        return rec;
      }
    }
