...
import static com.portier.oauth.providers.outlook.OutlookConstants.CLIENT_ID_OUTLOOK;
import static com.portier.oauth.providers.outlook.OutlookConstants.CLIENT_SECRET_OUTLOOK;
import static com.portier.oauth.providers.outlook.OutlookConstants.OUTLOOK_CALENDAR_AUTHORIZE_URL;
import static com.portier.oauth.providers.outlook.OutlookConstants.OUTLOOK_CALENDAR_TOKEN_URL;
import static com.portier.oauth.providers.outlook.OutlookConstants.SCOPE_OUTLOOK_CALENDAR;
 ...
 * @author DJ
 */
public final class OutlookCalendar extends OAuthProvider
{
  /**
  ...
  public OutlookCalendar()
  {
    ...
    this.clientId = getConfigProperty(CLIENT_ID_OUTLOOK);
    this.clientSecret = getConfigProperty(CLIENT_SECRET_OUTLOOK);
      ...
      final String state)
  {
    ...
    log.debug("Microsoft Calenar Client ID ->" + getClientId());
    log.debug(
        "Microsoft Calendar Client SECRET ->" + getClientSecret());
    log.debug("Microsoft Calendar authorization URL ->"
        + OUTLOOK_CALENDAR_AUTHORIZE_URL);
    log.debug("Microsoft Calendar token URL ->"
    ...
    return OAuth2ClientSupport
        ...
        .property(OAuth2CodeGrantFlow.Phase.AUTHORIZATION,
            OAuth2Parameters.SCOPE, (SCOPE_OUTLOOK_CALENDAR))
        .build();
  }
}
