...
/**
 * This class defines constants for Outlook services.
 * @author DJ
 */
public final class OutlookConstants
{
  /**
   * The upload uri.
   */
  public static final String OUTLOOK_UPLOAD_URI =
      "https://YOUR_COMPANY-my.sharepoint.com/_api/v2.0/drive";

  /**
   * The upload uri with children.
   */
  public static final String OUTLOOK_UPLOAD_URI_WITH_CHILDREN =
      OUTLOOK_UPLOAD_URI + "/root/children";

  /**
   * upload business uri.
   */
  public static final String OUTLOOK_UPLOAD_URI_BUSINESS =
      "https://YOUR_COMPANY-my.sharepoint.com/_api/v2.0/drive";

  /**
   * calendar.
   */
  public static final String OFFICE365_CALENDAR =
      "https://outlook.office.com/api/v2.0/me/events";

  /**
   * calendar params.
   */
  public static final String OFFICE365_CALENDAR_PARAMS =
      "Subject,CreatedDateTime,Start,End,Attendees,Organizer";

  /**
   * outlook drive authorize url.
   */
  public static final String OUTLOOK_DRIVE_AUTHORIZE_URL =
      "https://login.microsoftonline.com/common/oauth2/authorize";

  /**
   * outlook me url.
   */
  public static final String OUTLOOK_ME_URL =
      "https://outlook.office.com/api/v2.0/me";

  /**
   * outlook drive token url.
   */
  public static final String OUTLOOK_DRIVE_TOKEN_URL =
      "https://login.microsoftonline.com/common/oauth2/token";

  /**
   * outlook calendar authorize url.
   */
  public static final String OUTLOOK_CALENDAR_AUTHORIZE_URL =
      "https://login.microsoftonline.com/common/oauth2/v2.0/authorize";

  /**
   * outlook calendar token url.
   */
  public static final String OUTLOOK_CALENDAR_TOKEN_URL =
      "https://login.microsoftonline.com/common/oauth2/v2.0/token";

  /**
   * outlook calendar scope.
   */
  public static final String SCOPE_OUTLOOK_CALENDAR =
      "https://outlook.office.com/calendars.ReadWrite offline_access https://outlook.office.com/calendars.read.shared";

  /**
   * onedrive scope.
   */
  public static final String SCOPE_ONEDRIVE =
      "wl.signin wl.offline_access onedrive.readwrite";

  /**
   * client id.
   */
  public static final String CLIENT_ID_OUTLOOK = "CLIENT_ID_OUTLOOK";

  /**
   * client secret.
   */
  public static final String CLIENT_SECRET_OUTLOOK =
      "CLIENT_ID_OUTLOOK";

  /**
   * client id.
   */
  public static final String CLIENT_ID_ONEDRIVE =
      "CLIENT_ID_ONEDRIVE";

  /**
   * client secret.
   */
  public static final String CLIENT_SECRET_ONEDRIVE =
      "CLIENT_ID_ONEDRIVE";

  /**
   * OneDrive group client id.
   */
  public static final String CLIENT_ID_ONEDRIVE_GROUP =
      "CLIENT_ID_ONEDRIVE_GROUP";

  /**
   * OneDrive group client secret.
   */
  public static final String CLIENT_SECRET_ONEDRIVE_GROUP =
      "CLIENT_SECRET_ONEDRIVE_GROUP";
}
