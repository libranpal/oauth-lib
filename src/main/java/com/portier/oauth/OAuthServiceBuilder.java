...
/**
 * This class is used for building the OAuth Service.
 * @author sin
 */
public final class OAuthServiceBuilder
{
  // The provider class.
  private Class<? extends OAuthProvider> providerClass;
  ...
  /**
   * Creates an instance of the builder object.
   */
  public OAuthServiceBuilder()
  {
    // Default ctor; No impl required.
  }
   ...
   * @return  The builder.
   */
  public OAuthServiceBuilder addExtraProperty(String key,
      String value)
  {
    props.put(key, value);
    return this;
  ...
  /**
   * Sets the provider that provides the oauth service.
   *
   * @param providerClass The oauth provider class.
   * @return The builder.
   */
  public OAuthServiceBuilder provider(
      final Class<? extends OAuthProvider> providerClass)
  {
   ...
   * Sets the client id.
   *
   * <P> This method should be used only if the client id provided in the
   * configuration is required to be overridden. </P>
   *
   * @param clientId The client id.
   * @return The builder.
   */
  public OAuthServiceBuilder clientId(final String clientId)
  {
   ...
   * Sets the secret
   *
   * <P> This method should be used only if the secret provided in the
   * configuration is required to be overridden. </P>
   * @param secret The client secret.
   * @return The builder object.
   */
  public OAuthServiceBuilder secret(final String secret)
  {
    this.secret = secret;
    return this;
  }
   ...
   *
   * <P> This method should be used only if the redirectURI provided in the
   * configuration is required to be overridden. </P>
  
   * @param redirectURI The redirectURI.
   * @return The builder object.
   */
  public OAuthServiceBuilder redirectURI(final String redirectURI)
  {
  ...
  /**
   * Returns an oauth service object.
   *
   * @return The oauth service object.
   * @throws java.lang.Exception In case of any errors.
   */
  public OAuthService build() throws Exception
  {
    final OAuthProvider provider = providerClass.newInstance();
    // Override the client id or secret if provided explicitly.
    if (clientId != null)
    {
    ...
    return new OAuthServiceImpl(provider);
  }

  /**
   * The service implementation.
   */
  private static final class OAuthServiceImpl implements OAuthService
  {
    // The provider.
     ...
     */
    OAuthServiceImpl(final OAuthProvider provider)
    {
    ...
    public Response startAuthentication(
        ...
        throws Exception
    {
      return provider.startAuthGrantFlow(context);
    }
  }
}
